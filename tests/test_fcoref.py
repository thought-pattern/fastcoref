...
class TestFCoref(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.model = FCoref()
        self.expected_clusters = [[[(0, 2), (33, 36)], [(33, 50), (52, 64)]], [[(0, 7), (33, 36)], [(33, 41), (46, 48)]]]
    ...
    def test_predict_with_unexpected_object(self):
        ...
        self.assertEqual(
            str(exc.exception),
            f"texts argument expected to be a list of strings, " f"or one single text string. provided {type(texts)}",
        )
    ...
    def test_get_logits(self):
        ...
        self.assertEqual(str(exc.exception), 'span_i="the boot" is not an entity in this model!')
