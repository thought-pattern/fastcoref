...
def parse_args():
    ...
    parser.add_argument("--train_file", type=str, default=None, help="Training set file path. should be jsonlines.")
    parser.add_argument("--dev_file", type=str, default=None, help="Development set file path. should be jsonlines.")
    parser.add_argument("--test_file", type=str, default=None, help="Test set file path. should be jsonlines.")

    parser.add_argument(
        "--output_file", type=str, default=None, help="Prediction output file path. output will be in jsonlines format."
    )
